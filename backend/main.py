...
from backend.routers import issues, detection, grievances, utility, auth, admin, analysis, voice, resolution_proof, scorecard
...
app.include_router(scorecard.router, tags=["Scorecard"])
