...
const PlaygroundDetector = ({ onBack }) => {
    ...
    return (
        <div className="mt-6 flex flex-col items-center w-full">
            <h2 className="text-xl font-semibold mb-4 text-center">Playground Safety Inspector</h2>
            ...
            >
                {isDetecting ? 'Stop Inspection' : 'Start Inspection'}
            </button>

            <p className="text-sm text-gray-500 mt-2 text-center max-w-md">
                Point your camera at playground equipment to detect damage or safety hazards.
            </p>
