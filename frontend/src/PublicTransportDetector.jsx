...
const PublicTransportDetector = ({ onBack }) => {
    ...
    const drawDetections = (detections, context) => {
        ...
        context.strokeStyle = '#4B0082'; // Indigo
        context.lineWidth = 4;
    ...
    return (
        <div className="mt-6 flex flex-col items-center w-full">
            <h2 className="text-xl font-semibold mb-4 text-center">Bus Stop Inspector</h2>
            ...
            >
                {isDetecting ? 'Stop Inspector' : 'Start Inspector'}
            </button>

            <p className="text-sm text-gray-500 mt-2 text-center max-w-md">
                Point your camera at a bus stop or shelter to check for damage, cleanliness, or missing schedules.
            </p>
