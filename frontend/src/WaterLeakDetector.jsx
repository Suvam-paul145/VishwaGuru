  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-xl shadow-sm overflow-hidden">
      <div className="p-4 bg-cyan-600 text-white flex justify-between items-center">
        ...
        <button onClick={onBack} className="p-1 hover:bg-cyan-700 rounded-full">
          <X size={24} />
        </button>
      </div>
          ...
          <div className="w-full max-w-md bg-gray-100 rounded-lg overflow-hidden relative aspect-video flex flex-col items-center justify-center">
             {uploadMode ? (
                <div className="flex flex-col items-center p-8 text-center">
                  ...
                  <label className="bg-cyan-600 text-white px-6 py-2 rounded-full cursor-pointer hover:bg-cyan-700 transition font-medium">
                    Select Image
               ...
               <>
                ...
                <button
                  onClick={capture}
                  className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-white p-4 rounded-full shadow-lg border-4 border-cyan-200 active:scale-95 transition"
                >
          ...
          <div className="w-full max-w-md">
            ...
            {!loading && !error && detections.length === 0 && (
              <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded-r-lg flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-green-800">No Leakage!</h3>
                  <p className="text-green-700 text-sm">No water leakage detected.</p>
                </div>
              </div>
            )}
