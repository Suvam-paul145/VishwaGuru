...
const BlockedRoadDetector = ({ onBack }) => {
  ...
  return (
    <div className="p-4 max-w-md mx-auto h-full flex flex-col">
      ...
      <p className="mt-4 text-sm text-gray-600 text-center pb-4">
        Point camera at blocked roads or illegal parking.
      </p>
    </div>
  );
};
