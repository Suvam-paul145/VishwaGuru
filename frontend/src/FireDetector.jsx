...
const FireDetector = ({ onBack }) => {
  ...
  const detectFire = async () => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL || ''}/api/detect-fire`, {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <div className="flex flex-col h-full">
       <div className="flex justify-between items-center mb-4">
          ...
          <h2 className="text-xl font-bold text-gray-800">Fire Detector</h2>
      ...
      <div className="mt-4 space-y-3">
        ...
        {detections.length > 0 && (
          <div className="bg-red-50 border border-red-200 p-4 rounded-lg">
            <h3 className="font-bold text-red-800 mb-2">Detections:</h3>
            <ul className="list-disc pl-5 space-y-1">
             ...
             <div className="mt-2 text-xs text-red-600 font-semibold">
                ⚠️ If this is a real emergency, call 101 immediately!
            </div>
          </div>
        )}
