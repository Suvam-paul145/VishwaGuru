...
const TrafficDetector = ({ onBack }) => {
  ...
  const detectTraffic = async () => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL || ''}/api/detect-traffic`, {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <div className="flex flex-col h-full">
       <div className="flex justify-between items-center mb-4">
          ...
          <h2 className="text-xl font-bold text-gray-800">Traffic Detector</h2>
      ...
      <div className="mt-4 space-y-3">
        ...
        {detections.length > 0 && (
          <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg">
            <h3 className="font-bold text-yellow-800 mb-2">Detections:</h3>
          ...
          {!imgSrc ? (
            ...
            <>
              ...
              <button
                ...
                className="flex-1 bg-yellow-600 text-white py-3 rounded-xl font-bold hover:bg-yellow-700 transition"
              >
                Analyze
              </button>
            </>
