...
const AccessibilityDetector = ({ onBack }) => {
  ...
  const detectAccessibility = async () => {
    if (!imgSrc) return;
    setLoading(true);
    setDetections([]);
    ...
    try {
        ...
        const response = await fetch('/api/detect-accessibility', {
            method: 'POST',
            body: formData,
        });
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 max-w-md mx-auto w-full">
        <h2 className="text-2xl font-bold mb-4">Accessibility Issue Detector</h2>
        <p className="text-gray-600 mb-4 text-sm">Detect blocked ramps, stairs without ramps, etc.</p>
