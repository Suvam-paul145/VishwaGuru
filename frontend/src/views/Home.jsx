...
import {
  ...
  Volume2, Users, Waves, Accessibility, Siren, Recycle, Eye, ChevronUp, Signpost, Car, Wind, Bus, Smile
} from 'lucide-react';
  ...
  const categories = [
    {
      ...
      items: [
        ...
        { id: 'public-transport', label: 'Bus Stop', icon: <Bus size={24} />, color: 'text-indigo-600', bg: 'bg-indigo-50' },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 'playground', label: 'Playground', icon: <Smile size={24} />, color: 'text-pink-600', bg: 'bg-pink-50' },
